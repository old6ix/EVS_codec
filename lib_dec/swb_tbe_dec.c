...
)
{
    ...
    if( st->extl_brate == WB_TBE_0k35 )
    {
        mvr2r( lsf_wb, st->lsp_prevfrm, LPC_SHB_ORDER_LBR_WB );
    }
    else
    {
...
void GenTransition(
    ...
    float mem_resamp_HB_32k[],            /* i/o: memory                               */
    short *syn_dm_phase,
    int   output_Fs,
    float *up_mem,
    int   rf_flag
...
)
{
    ...
    {
        Decimate_allpass_steep( output, mem_resamp_HB_32k, L_FRAME32k, output );
    }
